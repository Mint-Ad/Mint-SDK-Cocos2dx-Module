...
static cocos2d::CCDictionary *spots = new cocos2d::CCDictionary;
...
static cocos2d::CCRect getAdRect(IMobileCocos2dxModule::AdAlignPosition adAlignPosition, IMobileCocos2dxModule::AdValignPosition adValignPosition, IMobileCocos2dxModule::AdType adType, IMobileCocos2dxModuleIconParams iconParams, bool sizeAdjust);
// 広告サイズを取得します
static cocos2d::CCSize getAdSize(IMobileCocos2dxModule::AdType adType, IMobileCocos2dxModuleIconParams iconParams,bool sizeAdjust);
// サイズ調整後の広告サイズを取得します
static cocos2d::CCSize getAdjustedAdSize(cocos2d::CCSize originalSize, bool sizeAdjust, IMobileCocos2dxModule::AdType adType);
...
int IMobileCocos2dxModule::show(const char* spotId, IMobileCocos2dxModule::AdType adType, IMobileCocos2dxModule::AdAlignPosition adAlignPosition, IMobileCocos2dxModule::AdValignPosition adValignPosition) {
    ...
    cocos2d::CCRect adRect = getAdRect(adAlignPosition, adValignPosition, adType, iconParams, false);
...
int IMobileCocos2dxModule::show(const char* spotId, IMobileCocos2dxModule::AdType adType, IMobileCocos2dxModule::AdAlignPosition adAlignPosition, IMobileCocos2dxModule::AdValignPosition adValignPosition, bool sizeAdjust){
	IMobileCocos2dxModuleIconParams iconParams;
    // 表示位置パラメータを座標に変換してから呼び出し
    cocos2d::CCRect adRect = getAdRect(adAlignPosition, adValignPosition, adType, iconParams, sizeAdjust);
...
static cocos2d::CCRect getAdRect(IMobileCocos2dxModule::AdAlignPosition adAlignPosition, IMobileCocos2dxModule::AdValignPosition adValignPosition, IMobileCocos2dxModule::AdType adType, IMobileCocos2dxModuleIconParams iconParams, bool sizeAdjust){
    ...
    // デバイスの物理サイズを取得
    cocos2d::CCSize frameSize = cocos2d::CCDirector::sharedDirector()->getOpenGLView()->getFrameSize();
    // 広告サイズを取得
    cocos2d::CCSize adSize = getAdSize(adType, iconParams, sizeAdjust);
    ...
    return cocos2d::CCRect(x, y, adSize.width, adSize.height);
}

// 広告サイズを取得します
static cocos2d::CCSize getAdSize(IMobileCocos2dxModule::AdType adType, IMobileCocos2dxModuleIconParams iconParams, bool sizeAdjust) {
	cocos2d::CCSize adSize;

	switch (adType) {
        case IMobileCocos2dxModule::BANNER:
        	adSize = getAdjustedAdSize(cocos2d::CCSize(320,50), sizeAdjust, adType);
            break;
        case IMobileCocos2dxModule::BIG_BANNER:
        	adSize = getAdjustedAdSize(cocos2d::CCSize(320,100), sizeAdjust, adType);
            break;
		case IMobileCocos2dxModule::TABLET_BANNER:
			adSize = cocos2d::CCSize(468,60);
			break;
		case IMobileCocos2dxModule::TABLET_BIG_BANNER:
			adSize = cocos2d::CCSize(728,90);
			break;
        case IMobileCocos2dxModule::MEDIUM_RECTANGLE:
        	adSize = getAdjustedAdSize(cocos2d::CCSize(300,250), sizeAdjust, adType);
            break;
		case IMobileCocos2dxModule::BIG_RECTANGLE:
			adSize = cocos2d::CCSize(336,280);
			break;
		case IMobileCocos2dxModule::SKYSCRAPER:
			adSize = cocos2d::CCSize(120,600);
			break;
		case IMobileCocos2dxModule::WIDE_SKYSCRAPER:
			adSize = cocos2d::CCSize(160,600);
			break;
		case IMobileCocos2dxModule::SQUARE:
			adSize = cocos2d::CCSize(250,250);
			break;
		case IMobileCocos2dxModule::SMALL_SQUARE:
			adSize = cocos2d::CCSize(200,200);
			break;
		case IMobileCocos2dxModule::HALFPAGE:
			adSize = cocos2d::CCSize(300,600);
			break;
        case IMobileCocos2dxModule::ICON:
            ...
            adSize = cocos2d::CCSize(iconAdWidth, iconAdHeight);
            break;
    }
	return adSize;
}
...
static cocos2d::CCSize getAdjustedAdSize(cocos2d::CCSize originalSize, bool sizeAdjust, IMobileCocos2dxModule::AdType adType){
    ...
    return cocos2d::CCSize(adjustedWidth, adjustedHeight);
}
...
void IMobileCocos2dxModule::addObserver(cocos2d::CCObject *target, IMobileCocos2dxModule::AdNotficationType adNotficationType, const char *spotId, cocos2d::SEL_CallFuncO selector) {
	cocos2d::CCNotificationCenter::sharedNotificationCenter()->addObserver(target, selector, getObserverEntryName(adNotficationType, spotId), NULL);
}
...
void IMobileCocos2dxModule::removeObserver(cocos2d::CCObject *target, IMobileCocos2dxModule::AdNotficationType adNotficationType, const char *spotId) {
	cocos2d::CCNotificationCenter::sharedNotificationCenter()->removeObserver(target, getObserverEntryName(adNotficationType, spotId));
}
...
cocos2d::CCSize IMobileCocos2dxModule::getDisplaySize(){
    ...
    return cocos2d::CCSize(screenWidth,screenHeight);
}
...
void static abnormalNotification(IMobileCocos2dxModule::AdNotficationType adNotficationType, const char* spotId, const char* reason) {
    cocos2d::CCString value = cocos2d::CCString(reason);
	...
	if ( strcmp("AD_NOT_READY", reason) == 0 ) {
		cocos2d::CCNotificationCenter::sharedNotificationCenter()->postNotification(getObserverEntryName(IMobileCocos2dxModule::DID_CLOSE, spotId) ,NULL);
	}
}
...
static const char* getObserverEntryName(IMobileCocos2dxModule::AdNotficationType adNotficationType, const char *spotId) {
	// オブザーバ登録名の作成
	cocos2d::CCString *observerEntryString;
	switch (adNotficationType) {
		case IMobileCocos2dxModule::DID_READY:
			observerEntryString = cocos2d::CCString::createWithFormat("IMOBILE_SDK_ADS_SPOT_DID_READY_%s", spotId);
			break;
		case IMobileCocos2dxModule::DID_FAIL:
			observerEntryString = cocos2d::CCString::createWithFormat("IMOBILE_SDK_ADS_SPOT_DID_FAIL_%s", spotId);
			break;
		case IMobileCocos2dxModule::DID_SHOW:
			observerEntryString = cocos2d::CCString::createWithFormat("IMOBILE_SDK_ADS_SPOT_DID_SHOW_%s", spotId);
			break;
		case IMobileCocos2dxModule::DID_CLICK:
			observerEntryString = cocos2d::CCString::createWithFormat("IMOBILE_SDK_ADS_SPOT_DID_CLICK_%s", spotId);
			break;
		case IMobileCocos2dxModule::DID_CLOSE:
			observerEntryString = cocos2d::CCString::createWithFormat("IMOBILE_SDK_ADS_SPOT_DID_CLOSE_%s", spotId);
			break;
	}
...
extern "C"
{
	...
	JNIEXPORT void JNICALL Java_jp_co_imobile_sdkads_android_cocos2dx_Module_onAdReadyCompleted(JNIEnv* env, jobject thiz, jstring spotId) {
		normalNotification(IMobileCocos2dxModule::DID_READY, env->GetStringUTFChars(spotId, 0));
	}
	//広告が表示された際に呼び出されます
	JNIEXPORT void JNICALL Java_jp_co_imobile_sdkads_android_cocos2dx_Module_onAdShowCompleted(JNIEnv* env, jobject thiz, jstring spotId) {
		normalNotification(IMobileCocos2dxModule::DID_SHOW, env->GetStringUTFChars(spotId, 0));
	}
	//広告がクリックされた際に呼び出されます
	JNIEXPORT void JNICALL Java_jp_co_imobile_sdkads_android_cocos2dx_Module_onAdCliclkCompleted(JNIEnv* env, jobject thiz, jstring spotId) {
		normalNotification(IMobileCocos2dxModule::DID_CLICK, env->GetStringUTFChars(spotId, 0));
	}
	//広告が閉じられた際に呼び出されます
	JNIEXPORT void JNICALL Java_jp_co_imobile_sdkads_android_cocos2dx_Module_onAdCloseCompleted(JNIEnv* env, jobject thiz, jstring spotId) {
		normalNotification(IMobileCocos2dxModule::DID_CLOSE, env->GetStringUTFChars(spotId, 0));
	}
	...
	JNIEXPORT void JNICALL Java_jp_co_imobile_sdkads_android_cocos2dx_Module_onFailed(JNIEnv* env, jobject thiz, jstring spotId, jstring reason) {
		abnormalNotification(IMobileCocos2dxModule::DID_FAIL, env->GetStringUTFChars(spotId, 0), env->GetStringUTFChars(reason, 0));
	}
}
