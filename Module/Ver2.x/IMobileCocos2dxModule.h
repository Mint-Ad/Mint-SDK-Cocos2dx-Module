...
public:
    ...
    // 広告状態通知用のオブザーバを登録します
    static void addObserver(cocos2d::CCObject *target, IMobileCocos2dxModule::AdNotficationType adNotficationType, const char *spotId, cocos2d::SEL_CallFuncO selector);
    // 広告状態通知用のオブザーバを削除します
    static void removeObserver(cocos2d::CCObject *target, IMobileCocos2dxModule::AdNotficationType adNotficationType, const char *spotId);
    // 端末の物理解像度の取得を行います
    ...
    // テストモードの設定をします
    static void setTestMode(bool testflg);
};
